...
function _load_menu()
	Menu = scriptConfig(""..ScriptName, "R&B")  	
		-----------------------------------------------------------------------------------------------------
		Menu:addSubMenu("范围设置", "draw")
		
				Menu.draw:addParam("info", " ", SCRIPT_PARAM_INFO, "")
				Menu.draw:addParam("reset", "Reset Colors", SCRIPT_PARAM_ONOFF, false)
				
				
			Menu.draw:addSubMenu("敌人范围", "prdraw")
				Menu.draw.prdraw:addParam("prdmg", "显示预测伤害", SCRIPT_PARAM_ONOFF, false)
				...
				Menu.draw.prdraw:addParam("enemy", "标记敌人", SCRIPT_PARAM_ONOFF, true)
				Menu.draw.prdraw:addParam("markcolor", "标记颜色", SCRIPT_PARAM_COLOR, {141, 124, 4, 4})
				Menu.draw.prdraw:addParam("info2", " ", SCRIPT_PARAM_INFO, "")				
				Menu.draw.prdraw:addParam("enemyline", "线上敌人", SCRIPT_PARAM_ONOFF, true)
				Menu.draw.prdraw:addParam("linecolor", "标记颜色", SCRIPT_PARAM_COLOR, {141, 124, 4, 4})			
		-----------------------------------------------------------------------------------------------------
				
		
		-----------------------------------------------------------------------------------------------------
			Menu.draw:addSubMenu("英雄范围", "drawsub2")
				Menu.draw.drawsub2:addParam("drawaa", "显示普攻范围", SCRIPT_PARAM_ONOFF, true)
					Menu.draw.drawsub2:addParam("aacolor", "范围颜色", SCRIPT_PARAM_COLOR, {141, 124, 4, 4})
					Menu.draw.drawsub2:addParam("info", " ", SCRIPT_PARAM_INFO, "")
					
					Menu.draw.drawsub2:addParam("drawQ", "显示Q范围", SCRIPT_PARAM_ONOFF, true)
					Menu.draw.drawsub2:addParam("qcolor", "范围颜色", SCRIPT_PARAM_COLOR, {141, 5, 247, 217})
					Menu.draw.drawsub2:addParam("info2", " ", SCRIPT_PARAM_INFO, "")
					
					Menu.draw.drawsub2:addParam("drawW", "显示W范围", SCRIPT_PARAM_ONOFF, true)
					Menu.draw.drawsub2:addParam("wcolor", "范围颜色", SCRIPT_PARAM_COLOR, {141, 7, 7, 247})
					Menu.draw.drawsub2:addParam("info2", " ", SCRIPT_PARAM_INFO, "")
					
					Menu.draw.drawsub2:addParam("drawE", "显示E范围", SCRIPT_PARAM_ONOFF, true)
					Menu.draw.drawsub2:addParam("ecolor", "范围颜色", SCRIPT_PARAM_COLOR, {141, 212, 12, 223})
					Menu.draw.drawsub2:addParam("info3", " ", SCRIPT_PARAM_INFO, "")
					
					Menu.draw.drawsub2:addParam("drawR", "显示R范围", SCRIPT_PARAM_ONOFF, true)
					Menu.draw.drawsub2:addParam("rcolor", "范围颜色", SCRIPT_PARAM_COLOR, {141, 247, 247, 0})
					Menu.draw.drawsub2:addParam("info4", " ", SCRIPT_PARAM_INFO, "")					
		-----------------------------------------------------------------------------------------------------

		
		-----------------------------------------------------------------------------------------------------
		Menu:addSubMenu("消耗设置", "harrass")		
				Menu.harrass:addParam("autohrsQ", "使用Q", SCRIPT_PARAM_ONOFF, true)
				Menu.harrass:addParam("autohrsW", "使用W", SCRIPT_PARAM_ONOFF, true)
				Menu.harrass:addParam("autohrsE", "使用E", SCRIPT_PARAM_ONOFF, true)
				Menu.harrass:addParam("autohrsR", "使用R", SCRIPT_PARAM_ONOFF, true)
		-----------------------------------------------------------------------------------------------------
		
		
		-----------------------------------------------------------------------------------------------------
		Menu:addSubMenu("团战设置", "rota")			
				Menu.rota:addParam("useQ", "使用Q", SCRIPT_PARAM_ONOFF, true)
				Menu.rota:addParam("useW", "使用W", SCRIPT_PARAM_ONOFF, true)
				Menu.rota:addParam("useE", "使用E", SCRIPT_PARAM_ONOFF, true)
				Menu.rota:addParam("useR", "使用R", SCRIPT_PARAM_ONOFF, true)
		-----------------------------------------------------------------------------------------------------
		
		
		-----------------------------------------------------------------------------------------------------
		Menu:addSubMenu("清线设置", "laneclear")		
				Menu.laneclear:addParam("autolcQ", "使用Q", SCRIPT_PARAM_ONOFF, true)				
				Menu.laneclear:addParam("autolcE", "使用E", SCRIPT_PARAM_ONOFF, true)
				Menu.laneclear:addParam("autolcR", "使用R", SCRIPT_PARAM_ONOFF, true)
		-----------------------------------------------------------------------------------------------------
		
		Menu:addSubMenu("法力管理", "manamenu")
			Menu.manamenu:addSubMenu("消耗模式", "manahrs")
				Menu.manamenu.manahrs:addParam("manaq", "开启Q技能管理", SCRIPT_PARAM_ONOFF, false)  
				Menu.manamenu.manahrs:addParam("sliderq", "使用Q蓝量不能低于%",  SCRIPT_PARAM_SLICE, 50, 0, 100, 0)  
				Menu.manamenu.manahrs:addParam("manaw", "开启W技能管理", SCRIPT_PARAM_ONOFF, false) 
				Menu.manamenu.manahrs:addParam("sliderw", "使用W蓝量不能低于%",  SCRIPT_PARAM_SLICE, 50, 0, 100, 0) 
				Menu.manamenu.manahrs:addParam("manae", "开启E技能管理", SCRIPT_PARAM_ONOFF, false) 
				Menu.manamenu.manahrs:addParam("slidere", "使用E蓝量不能低于%",  SCRIPT_PARAM_SLICE, 50, 0, 100, 0) 
				Menu.manamenu.manahrs:addParam("manar", "开启R技能管理", SCRIPT_PARAM_ONOFF, false) 
				Menu.manamenu.manahrs:addParam("sliderr", "使用R蓝量不能低于%",  SCRIPT_PARAM_SLICE, 50, 0, 100, 0) 
			Menu.manamenu:addSubMenu("团战模式", "manarota")
				Menu.manamenu.manarota:addParam("manaq", "开启Q技能管理", SCRIPT_PARAM_ONOFF, false) 
				Menu.manamenu.manarota:addParam("sliderq", "使用Q蓝量不能低于%",  SCRIPT_PARAM_SLICE, 50, 0, 100, 0) 
				Menu.manamenu.manarota:addParam("manaw", "开启W技能管理", SCRIPT_PARAM_ONOFF, false) 
				Menu.manamenu.manarota:addParam("sliderw", "使用W蓝量不能低于%",  SCRIPT_PARAM_SLICE, 50, 0, 100, 0) 
				Menu.manamenu.manarota:addParam("manae", "开启E技能管理", SCRIPT_PARAM_ONOFF, false) 
				Menu.manamenu.manarota:addParam("slidere", "使用E蓝量不能低于%",  SCRIPT_PARAM_SLICE, 50, 0, 100, 0) 
				Menu.manamenu.manarota:addParam("manar", "开启R技能管理", SCRIPT_PARAM_ONOFF, false) 
				Menu.manamenu.manarota:addParam("sliderr", "使用R蓝量不能低于%",  SCRIPT_PARAM_SLICE, 50, 0, 100, 0)
			Menu.manamenu:addSubMenu("清线模式", "manalc")
				Menu.manamenu.manalc:addParam("manaq", "开启Q技能管理", SCRIPT_PARAM_ONOFF, false) 
				Menu.manamenu.manalc:addParam("sliderq", "使用Q蓝量不能低于%",  SCRIPT_PARAM_SLICE, 50, 0, 100, 0) 
				Menu.manamenu.manalc:addParam("manae", "开启E技能管理", SCRIPT_PARAM_ONOFF, false) 
				Menu.manamenu.manalc:addParam("slidere", "使用E蓝量不能低于%",  SCRIPT_PARAM_SLICE, 50, 0, 100, 0) 
				Menu.manamenu.manalc:addParam("manar", "开启R技能管理", SCRIPT_PARAM_ONOFF, false) 
				Menu.manamenu.manalc:addParam("sliderr", "使用R蓝量不能低于%",  SCRIPT_PARAM_SLICE, 50, 0, 100, 0)
		-----------------------------------------------------------------------------------------------------
		Menu:addSubMenu("按键设置", "keys")		
			Menu.keys:addParam("permrota", "自动团战", SCRIPT_PARAM_ONKEYTOGGLE, false, string.byte("L"))
			Menu.keys:permaShow("permrota")
			Menu.keys:addParam("okdrota", "团战按键", SCRIPT_PARAM_ONKEYDOWN, false, string.byte("32"))
			Menu.keys:permaShow("okdrota")		
			Menu.keys:addParam("permhrs", "自动消耗", SCRIPT_PARAM_ONKEYTOGGLE, false, string.byte("L"))
			Menu.keys:permaShow("permhrs")
			Menu.keys:addParam("okdhrs", "消耗按键", SCRIPT_PARAM_ONKEYDOWN, false, string.byte("T"))
			Menu.keys:permaShow("okdhrs")
			Menu.keys:addParam("okdlc", "清线按键", SCRIPT_PARAM_ONKEYDOWN, false, string.byte("Z"))
		...
		Menu:addSubMenu("Target acquisition", "ta")	
			...
			if VIP_USER and not prodicfile and vpredicfile then
				...
				Menu.ta.co = 3 
				Menu.ta:addParam("vphit", "VP预判准度", SCRIPT_PARAM_LIST, 3, {"[0]目标方向","[1]中等概率", "[2]高等概率", "[3]当目标减速/靠近", "[4]目标被控制", "[5]必中(超慢)" })  
			end
		...
		Menu:addSubMenu("高级设置", "extra")
			Menu.extra:addSubMenu("Extended", "ex")
				...
				if VIP_USER then
					Menu.extra.ex:addParam("packetmove", "移动模式", SCRIPT_PARAM_LIST, 1, { "正常", "Packets" })
				else
